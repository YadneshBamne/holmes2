...
const Navbar = () => {
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-house-lock ml-6" viewBox="0 0 16 16">
  ...
  <Link href={"./"}><ul className='mx-10'>Home</ul></Link>
  <Link href={"./aboutus"}><ul className='mx-10 '>About Us</ul></Link>
  </div>
  <button type='button'>
